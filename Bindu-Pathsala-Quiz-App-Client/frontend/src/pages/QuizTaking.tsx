...
import { quizAPI, attemptAPI, API_URL } from '@/services/api';
...
export const QuizTaking: React.FC = () => {
  ...
  }, [state.currentQuestionIndex, state.questions, state.quiz, state.questionStartTimes, state.expiredQuestions, setQuestionTimeRemaining, setExpiredQuestion, setQuestionStartTime, loadTimingData]);
                    ...
                    <div className="flex-1">
                      ...
                      {currentQuestion.image_path && (
                        <div className="mt-3">
                          <img
                            src={
                              currentQuestion.image_path.startsWith('/') || 
                              currentQuestion.image_path.includes('uploads') ||
                              currentQuestion.image_path.startsWith('http')
                                ? `${apiBaseUrl}${currentQuestion.image_path}`
                                : `${apiBaseUrl}/uploads/${currentQuestion.image_path}`
                            }
                            alt="Question"
