...
func SetupRouter(cfg *config.Config) http.Handler {
	...
	r.PathPrefix("/uploads/").Handler(http.StripPrefix("/uploads/", http.FileServer(http.Dir(cfg.FileUpload.UploadPath))))
	...
	// Admin - File upload
	admin.HandleFunc("/upload/image", fileHandler.UploadImage).Methods("POST", "OPTIONS")
